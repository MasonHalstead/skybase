...
EmailEmitter.on('send_verify_email', async user => {
  await transporter.sendMail({
    ...
    .es-button-border:hover a.es-button {
      background:#49566a!important;
      border-color:#49566a!important;
    }
    .es-button-border:hover {
      border-color:#5e6e87 #5e6e87 #5e6e87 #5e6e87!important;
      background:#49566a!important;
    }
    </style> 
     </head> 
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                     <tr style="border-collapse:collapse;"> 
                      <td width="660" align="center" valign="top" style="padding:0;Margin:0;"> 
                       <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                         <tr style="border-collapse:collapse;"> 
                          <td align="center" style="padding:0;Margin:0;"><img class="adapt-img" src="https://eiiuic.stripocdn.email/content/guids/CABINET_15b741f07f31e271219b59c051b329d4/images/50891573097786248.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="225"></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td width="660" align="center" valign="top" style="padding:0;Margin:0;"> 
                       <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                         ...
                         <tr style="border-collapse:collapse;"> 
                          <td align="center" style="padding:10px;Margin:0;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:verdana, geneva, sans-serif;line-height:27px;color:#333333;"><b>TEMPORARY PASSWORD</b></p></td> 
                         </tr> 
                         <tr style="border-collapse:collapse;"> 
                          <td align="center" style="padding:10px;Margin:0;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:verdana, geneva, sans-serif;line-height:27px;color:#333333;"><strong>${user.temporary_password}</strong></p></td> 
                         </tr> 
                       </table></td> 
                     </tr> 
                   </table></td> 
